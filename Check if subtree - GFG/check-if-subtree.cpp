...
class Solution{
    bool match(Node* t,Node *s){
        ...
        if(match(t->left,s->left) and match(t->right,s->right)) return true;
        return false;
    }
  public:
    bool isSubTree(Node* T, Node* S){
        ...
        if(T->data == S->data and match(T,S)) return true;
        if(isSubTree(T->left,S) || isSubTree(T->right,S)) return true;
